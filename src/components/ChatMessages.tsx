...
export const UserMessage = ({ content, createdAt }: MessageProps) => (
  <div className="flex justify-end">
    <div className="max-w-[80%]">
      <div
        className="rounded-[12px_12px_4px_12px] bg-primary px-4 py-3 font-body text-[15px] leading-relaxed text-primary-foreground"
      >
        {content}
      </div>
...
export const AssistantMessage = ({ content, createdAt }: MessageProps) => (
  <div className="flex justify-start">
    <div className="max-w-[80%]">
      ...
      <div
        className="rounded-[12px_12px_12px_4px] bg-[hsl(var(--surface-elevated))] px-4 py-3 font-body text-[15px] leading-relaxed text-foreground"
      >
